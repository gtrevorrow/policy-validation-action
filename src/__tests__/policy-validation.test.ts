...
describe('Policy Validation Integration', () => {
  ...
  describe('End-to-End Validation', () => {
    ...
    it('should validate with both local and global pipelines', async () => {
      ...
      // Test local pipeline
      const localPipeline = await ValidatorFactory.createLocalPipeline(mockLogger, {});
      ...
      const globalPipeline = await ValidatorFactory.createGlobalPipeline(mockLogger, {
    ...
    it('should use agentic validator via factory for policies with variables', async () => {
      ...
      const hybridPipeline = await ValidatorFactory.createGlobalPipeline(mockLogger, options);
